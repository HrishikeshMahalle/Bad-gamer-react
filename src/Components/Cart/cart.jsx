...
export default function Cart() {
    ...
    useEffect(()=>{
        cartlist.map((item)=> setCartItem(ite => ite + parseInt(products.filter(product => product.id === item.id)[0].price)))
    },[cartlist])
            ...
            <div className="cart-content">
                ...
                <div className="cart-items">
                    <div className="cart-item">
                        ...
                        return <CardHorizon key={key} quant={item.quant} product={products.filter(product => product.id === item.id)[0]}/>
                        })}
                    </div>
                </div>
            </div>
